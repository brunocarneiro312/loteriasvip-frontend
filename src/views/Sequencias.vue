         ...
         <div class="container px-5 mx-auto">
            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
               ...
               <div class="sm:w-1/2 mb-10 px-4">
                  ...
                  <input style="max-width: 200px" class="mt-3 w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2" placeholder="Jogos por cliente" type="number">
                  <button class="flex mx-auto mt-6 text-white bg-green-500 border-0 py-2 px-5 focus:outline-none hover:bg-green-600 rounded">Distribuição avulsa</button>
               </div>
            </div>
         </div>
      </section>
        ...
        methods: {
            ...
            async distribuirIgualmente() {
                ...
                if (qtdClientes && qtdJogosSemDono) {
                    console.log(qtdJogosPorCliente);
